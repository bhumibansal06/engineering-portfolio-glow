  ...
  return (
    <button
      className={cn(
        ...
        "h-12 min-w-[160px] whitespace-nowrap rounded-[28px] px-6 py-3",
        ...
        isDark
          ...
          : "[box-shadow:inset_0_0_0_1px_hsl(var(--border))] border border-gray-300 dark:border-transparent",
        ...
        isDark
          ...
          : "after:[box-shadow:inset_0_0_0_1px_hsl(var(--border)),0_0_3px_hsl(var(--ring))] border-gray-300",
